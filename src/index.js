...
function generateHaiku(event) {
  ...
  let context =
    "You are a haiku generator. You write a haiku with every of haiku rules. Every first line of Haiku has 5 syllables, the second line has 7 syllables, and the third has 5 syllables - this is very important. Print every verse in next line with using <br />. Always sign at the end in new line using <br /> as '- SheCodes AI' inside <strong> element ";
